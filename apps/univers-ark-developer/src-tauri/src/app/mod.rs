...
pub(crate) fn run() {
    ...
    builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::machine::config::import_machine_configs,
            commands::machine::config::upsert_profile_config,
            commands::machine::config::update_default_profile,
            commands::machine::config::move_machine_config,
